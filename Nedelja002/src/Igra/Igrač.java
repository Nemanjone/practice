...
public class Igraè extends PokretniObjekat {

	private String ime = "";
	private double snaga = 0;
	private double život = 0;
	public Igraè(Lokacija lokacija, String slika, Brzina brzina) {
	...
	public double getŽivot() {
		return život;
	}
	public void setŽivot(double život) {
		this.život = život;
	}
